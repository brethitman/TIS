...
export class EstadisticasComponent implements OnInit {
 ...
 async exportarPDF() {
  ...
  // Nuevo método para dividir texto que no cabe en el ancho especificado
    ...
    for (const word of words) {
      ...
      if (textWidth <= maxWidth) {
        ...
        if (currentLine) {
          ...
          // Si una sola palabra es muy larga, córtala
  ...
  // Método auxiliar mejorado para colores de estado con paleta azul
